...
<html lang="en" class="js" xmlns:fb="http://www.facebook.com/2008/fbml">
	...
	<head>
		...
		<title>Edit Category | Yelp</title>
				...
				<div class="container review_rate usd">
					<div class="clearfix layout-block layout-a layout-border">
						<div class="column column-alpha ">
							<form name="review_rate_form" method="POST" id="review_rate_form" action="Categories?action=save">
								<div class="clearfix" id="war-header">
									<h2>
										<strong>
										Edit Category:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if(request.getAttribute("msg")!=null)%><%= (String)request.getAttribute("msg") %>
										</strong>
									</h2>
								</div>
								...
								<div class="clearfix" id="review_rate_form_footer">
									<p class="clearfix">
										<a href="Categories?action=home">Cancel</a>
										<input type="hidden" id="rating-form-action" value="submit" name="action_submit">
										<button class="ybtn ybtn-primary ybtn-small" value="submit" type="submit" id="review-submit-button"><span>Update</span></button>
									</p>
